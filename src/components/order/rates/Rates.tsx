...
function Rates() {
  ...
  return (
    <div>
      ...
      <div className="text-center">Koszt Twojego następnego zamówienia, jeśli wybierzesz abonament</div>
        ...
        {rates?.map((rate, index) => (
          <button
            ...
            onClick={() => {
              ...
              store.setActualRate(rate.discount)
            }}
          ...
          >
            <div>
              ...
              {index === rates.length - 1 ? null : (
                <div className="my-4">
                  <p className="bg-orange-700 py-2 px-4 max-w-fit mx-auto">-{rate.discount}</p>
                </div>
              )}
            </div>
          </button>
